...
<body>
    ...
    <section class="cont logo">
        <div class="row d-flex">
            ...
            <div class="col-lg-5 logo_search">
                ...
                <button class="s">অনুসন্ধান </button>
            </div>
    ...
    <section class="cont">
        <div class="row hero mt-3">
            <div class="col-lg-8 hero_main">
                ...
                <div class="teb">
                  ...
                  <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                      ...
                      <div class="row tab_class text-center">
                        ...
                        <div class="col-lg-2">
                          <a href="#"><?php the_post_thumbnail();?><br><?php the_title();?></a>
                        </div>
                      <?php }?>
                        <!-- <div class="col-lg-2">
                ...
                <!-- list section -->
                <div class="cont list">
                  <?php dynamic_sidebar('sidebartext1')?>
            ...
            <div class="col-lg-4 hero_side">
              ...
              <div class="side_video">
                ...
                <?php dynamic_sidebar('sidebarbigimg'); ?>
        ...
        <div class="col-lg-7 fb_left">
          <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid">
              ...
              <?php wp_nav_menu([
                    'theme_location'=>'FM',
                    'menu_class'=>'navbar-nav nav_botom'
                  ]);?>
    ...
    <div class="cont">
      <div class="row branching text-center py-3">
        <div class="col-lg-4">
          <?php
            $num=1;
            while($num<=10){
        ...
        <div class="col-lg-4">
          <?php
            $mark2=50;
            echo ($mark2>=40)?' <h1>pass</h1>' : '<h1>fail</h1>';
          ?>
        </div>
